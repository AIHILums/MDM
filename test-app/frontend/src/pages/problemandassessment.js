...
const PlanAndOrder = () => {
    ...
    const RunReplicate = async () => {
        try {
            const response = await axios.post("http://localhost:8000/problemandassessment/replicate", {prompt: prompt});
...
<div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-6">
            <div className="bg-white shadow-lg rounded-lg p-8 max-w-3xl w-full">
                <h1 className="text-3xl font-bold text-gray-800 mb-6 text-center">Replicate Runner - Problem and Assessment</h1>
                <textarea
                    value={prompt}
